                    ...
                    ->components([
                            ...
                            ->components([
                                Grid::make(2)
                                    ->components([
                                        ...
                                        Fieldset::make('Disposal Type')
                                            ->components([
                                                Text::make(fn () => $record->disposalType?->name ?: 'Not specified')
                                                    ->color('warning')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('Meat Obtained')
                                            ->components([
                                                Text::make(fn () => $record->meat_obtained ? 'Yes' : 'No')
                                                    ->color(fn () => $record->meat_obtained ? 'success' : 'danger')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('Vet')
                                            ->components([
                                                Text::make(fn () => $record->vet?->name ?: 'Not specified')
                                                    ->color('info')
                                                    ->weight('bold'),
                                            ]),
                                        ...
                                        Fieldset::make('Extension Officer')
                                            ->components([
                                                Text::make(fn () => $record->extensionOfficer?->name ?: 'Not specified')
                                                    ->color('info')
                                                    ->weight('bold'),
                                            ]),
                        ...
                        Section::make('Additional Information')
                            ->components([
                                Grid::make(2)
                                    ->components([
                                        Fieldset::make('Reasons')
                                            ->components([
                                                Text::make(fn () => $record->reasons ?: 'No reasons specified')
                                                    ->color('gray')
                                                    ->columnSpanFull(),
                                            ]),
