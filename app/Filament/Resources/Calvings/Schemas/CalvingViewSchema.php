                            ...
                            ->components([
                                Grid::make(2)
                                    ->components([
                                        ...
                                        Fieldset::make('Calving Type')
                                            ->components([
                                                Text::make(fn () => $record->calvingType?->name ?: 'Not specified')
                                                    ->color('success')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('Calving Problem')
                                            ->components([
                                                Text::make(fn () => $record->calvingProblem?->name ?: 'Not specified')
                                                    ->color('warning')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('Reproductive Problem')
                                            ->components([
                                                Text::make(fn () => $record->reproductiveProblem?->name ?: 'Not specified')
                                                    ->color('danger')
                                                    ->weight('bold'),
                                            ]),
