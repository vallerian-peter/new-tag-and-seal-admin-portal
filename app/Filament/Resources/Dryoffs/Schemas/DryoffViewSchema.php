                                ...
                                Grid::make(2)
                                    ->components([
                                        Fieldset::make('Start Date')
                                            ->components([
                                                Text::make(fn () => $record->start_date ? $record->start_date->format('Y-m-d') : 'Not specified')
                                                    ->color('info')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('End Date')
                                            ->components([
                                                Text::make(fn () => $record->end_date ? $record->end_date->format('Y-m-d') : 'Not specified')
                                                    ->color('warning')
                                                    ->weight('bold'),
                                            ]),

                                        Fieldset::make('Expected Calving Date')
                                            ->components([
                                                Text::make(fn () => $record->expected_calving_date ? $record->expected_calving_date->format('Y-m-d') : 'Not specified')
                                                    ->color('success')
                                                    ->weight('bold'),
                                            ]),
                                    ]),
